    ...
    public static class LinqTasks
    {
        ...
        public static IEnumerable<object> Task6()
        {
            IEnumerable<object> result = Emps
                ...
                .Select(ed => new {ed.Emps.Ename, ed.Emps.Job, ed.Depts.Dname})
                .AsEnumerable();
            return result;
        }

        /// <summary>
        ///     SELECT Job AS Praca, COUNT(1) LiczbaPracobwnikow FROM Emps GROUP BY Job;
        /// </summary>
        public static IEnumerable<object> Task7()
        {
            IEnumerable<object> result = Emps
                .GroupBy(e => e.Job)
                .Select(egrb => new {LiczbaPracownikow = egrb.Count(),Praca = egrb.Key})
                .AsEnumerable();
            return result;
        }
        ...
        public static IEnumerable<object> Task10()
        {
            IEnumerable<object> result = Emps
	            ...
	            .Concat(new[] {new {Ename = "Brak wartości", Job = (string)null, Hiredate = (DateTime?)null}}); ;
            return result;
        }
